...
public class ThreadDemo3 {
    ...
    // Una constante BigDecimal con valor 4
    ...
    public static void main(String[] args) {
        Runnable r = () ->
        {
            // llama a computePi(50000) y almacena el resultado en result.
            result = computePi(50000);
        };
        Thread t = new Thread(r);
        // lanzamos el nuevo hilo t
        t.start();

        // Espera a que el hilo termine su ejecución antes de continuar.
        // Esto asegura que el resultado se imprima solo después de que el cálculo haya finalizado.
        try
        {
            t.join();
        }
    ...
    {
        // Calcula el valor de pi a un número específico de dígitos
        int scale = digits + 5;
